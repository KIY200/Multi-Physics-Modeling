function [FIR_causal,FIR_non_causal] = Excitation_FIR(Hydro_coef_location)
...
IRF_Fex = h5read(Hydro_coef_location,'/body1/hydro_coeffs/excitation/impulse_response_fun/f');
